...
public class BiomassUpgradeInfo
{
    ...
    public ArrayList<Requirement> showRequirements; //TODO InteractionHand requirements
    public ArrayList<Requirement> requirements; //TODO InteractionHand requirements
    ...
    public ResourceLocation getTextureLocation()
    {
        if(textureLocation == null)
        {
            ...
            {
                textureLocation = ResourceLocation.parse(textureLocationOverride);
            }
            else
            {
                textureLocation = ResourceLocation.fromNamespaceAndPath("morph", "textures/biomass/upgrade/" + id + ".png");
            }
        }
