...
public interface IApi
{
    //Helpers
    @Nonnull
    default GameProfile getGameProfile(@Nullable UUID uuid, @Nullable String name) { return new GameProfile(uuid != null ? uuid : net.minecraft.Util.NIL_UUID, name != null ? name : ""); }
